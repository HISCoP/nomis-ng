        ...
        <Card>
            <CardBody>
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography color="textPrimary">School Setup</Typography>
                </Breadcrumbs>
                <br/>
                <div className={"d-flex justify-content-end pb-2"}>
                    <Button variant="contained"
                            ...
                            >
                        <span style={{textTransform: 'capitalize'}}> New School</span>
                    </Button>
                ...
                <MaterialTable
                    ...
                    { title: "Address", field: "description" },
            ...
            <NewSchool toggleModal={toggleModal} showModal={showModal} loadIpList={props.ipList} formData={currentProject} loadIps={loadCboProjectList}/>
