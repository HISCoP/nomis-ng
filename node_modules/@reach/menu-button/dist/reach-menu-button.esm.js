...
import { createNamedContext, makeId, useCheckStyles, isFunction, forwardRefWithAs, useForkedRef, wrapEvent, getOwnerDocument, usePrevious, isString, noop } from '@reach/utils';
...
var Menu = function Menu(_ref) {
  ...
  return /*#__PURE__*/createElement(DescendantProvider, {
    ...
    items: descendants,
    set: setDescendants
  }, /*#__PURE__*/createElement(MenuContext.Provider, {
    value: context
...
var MenuLink = /*#__PURE__*/forwardRefWithAs(function MenuLink(_ref6, forwardedRef) {
  ...
  return /*#__PURE__*/createElement("div", {
    role: "none",
    tabIndex: -1
  }, /*#__PURE__*/createElement(MenuItemImpl, _extends({}, props, {
    ref: forwardedRef,
